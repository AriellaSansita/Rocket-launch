...
st.info("**Insight:** A strong positive correlation exists; heavier payloads consistently require more fuel to reach the target distance.")
...
with col2:
    ...
    st.pyplot(fig3)
    st.write("**Insight:** Successful missions show a consistent crew size range, whereas failures often correlate with extreme outliers.")

# 4. Line Chart: Duration vs Distance
...
# Physical Constants
g = 9.81  # Gravity
burn_rate = 1500  # Fuel consumption rate in kg/s
dt = 1.0  # Time step
time_steps = 200
